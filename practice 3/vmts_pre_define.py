...
from dict_objectified import DictObject
...
class Predefine(object):
    ...
    def save(self):
        ...
        for i in self._module:
            with open(i[2] + pSlash + ''.join(i[0:1]), 'w') as fl:
